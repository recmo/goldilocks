...
pub fn ntt_102(values: &mut [Field]) {
    debug_assert_eq!(values.len(), 102);
    let a0 = values[0];
    let a1 = values[1];
    let a2 = values[2];
    let a3 = values[3];
    ...
    let (a0, a34, a68) = (a0 + a34 + a68,
        a0 + (a34 << 64) - (a68 << 32),
        a0 - (a34 << 32) + (a68 << 64));
    let (a51, a85, a17) = (a51 + a85 + a17,
        a51 + (a85 << 64) - (a17 << 32),
        a51 - (a85 << 32) + (a17 << 64));
    let (a0, a51) = (a0 + a51, a0 - a51);
    let (a34, a85) = (a34 + a85, a34 - a85);
    let (a68, a17) = (a68 + a17, a68 - a17);
    let (a6, a40, a74) = (a6 + a40 + a74,
        a6 + (a40 << 64) - (a74 << 32),
        a6 - (a40 << 32) + (a74 << 64));
    let (a57, a91, a23) = (a57 + a91 + a23,
        a57 + (a91 << 64) - (a23 << 32),
        a57 - (a91 << 32) + (a23 << 64));
    let (a6, a57) = (a6 + a57, a6 - a57);
    let (a40, a91) = (a40 + a91, a40 - a91);
    let (a74, a23) = (a74 + a23, a74 - a23);
    let (a66, a100, a32) = (a66 + a100 + a32,
        a66 + (a100 << 64) - (a32 << 32),
        a66 - (a100 << 32) + (a32 << 64));
    let (a15, a49, a83) = (a15 + a49 + a83,
        a15 + (a49 << 64) - (a83 << 32),
        a15 - (a49 << 32) + (a83 << 64));
    let (a66, a15) = (a66 + a15, a66 - a15);
    let (a100, a49) = (a100 + a49, a100 - a49);
    let (a32, a83) = (a32 + a83, a32 - a83);
    let (a36, a70, a2) = (a36 + a70 + a2,
        a36 + (a70 << 64) - (a2 << 32),
        a36 - (a70 << 32) + (a2 << 64));
    let (a87, a19, a53) = (a87 + a19 + a53,
        a87 + (a19 << 64) - (a53 << 32),
        a87 - (a19 << 32) + (a53 << 64));
    let (a36, a87) = (a36 + a87, a36 - a87);
    let (a70, a19) = (a70 + a19, a70 - a19);
    let (a2, a53) = (a2 + a53, a2 - a53);
    let (a30, a64, a98) = (a30 + a64 + a98,
        a30 + (a64 << 64) - (a98 << 32),
        a30 - (a64 << 32) + (a98 << 64));
    let (a81, a13, a47) = (a81 + a13 + a47,
        a81 + (a13 << 64) - (a47 << 32),
        a81 - (a13 << 32) + (a47 << 64));
    let (a30, a81) = (a30 + a81, a30 - a81);
    let (a64, a13) = (a64 + a13, a64 - a13);
    let (a98, a47) = (a98 + a47, a98 - a47);
    let (a48, a82, a14) = (a48 + a82 + a14,
        a48 + (a82 << 64) - (a14 << 32),
        a48 - (a82 << 32) + (a14 << 64));
    let (a99, a31, a65) = (a99 + a31 + a65,
        a99 + (a31 << 64) - (a65 << 32),
        a99 - (a31 << 32) + (a65 << 64));
    let (a48, a99) = (a48 + a99, a48 - a99);
    let (a82, a31) = (a82 + a31, a82 - a31);
    let (a14, a65) = (a14 + a65, a14 - a65);
    let (a96, a28, a62) = (a96 + a28 + a62,
        a96 + (a28 << 64) - (a62 << 32),
        a96 - (a28 << 32) + (a62 << 64));
    let (a45, a79, a11) = (a45 + a79 + a11,
        a45 + (a79 << 64) - (a11 << 32),
        a45 - (a79 << 32) + (a11 << 64));
    let (a96, a45) = (a96 + a45, a96 - a45);
    let (a28, a79) = (a28 + a79, a28 - a79);
    let (a62, a11) = (a62 + a11, a62 - a11);
    let (a78, a10, a44) = (a78 + a10 + a44,
        a78 + (a10 << 64) - (a44 << 32),
        a78 - (a10 << 32) + (a44 << 64));
    let (a27, a61, a95) = (a27 + a61 + a95,
        a27 + (a61 << 64) - (a95 << 32),
        a27 - (a61 << 32) + (a95 << 64));
    let (a78, a27) = (a78 + a27, a78 - a27);
    let (a10, a61) = (a10 + a61, a10 - a61);
    let (a44, a95) = (a44 + a95, a44 - a95);
    let (a60, a94, a26) = (a60 + a94 + a26,
        a60 + (a94 << 64) - (a26 << 32),
        a60 - (a94 << 32) + (a26 << 64));
    let (a9, a43, a77) = (a9 + a43 + a77,
        a9 + (a43 << 64) - (a77 << 32),
        a9 - (a43 << 32) + (a77 << 64));
    let (a60, a9) = (a60 + a9, a60 - a9);
    let (a94, a43) = (a94 + a43, a94 - a43);
    let (a26, a77) = (a26 + a77, a26 - a77);
    let (a72, a4, a38) = (a72 + a4 + a38,
        a72 + (a4 << 64) - (a38 << 32),
        a72 - (a4 << 32) + (a38 << 64));
    let (a21, a55, a89) = (a21 + a55 + a89,
        a21 + (a55 << 64) - (a89 << 32),
        a21 - (a55 << 32) + (a89 << 64));
    let (a72, a21) = (a72 + a21, a72 - a21);
    let (a4, a55) = (a4 + a55, a4 - a55);
    let (a38, a89) = (a38 + a89, a38 - a89);
    let (a12, a46, a80) = (a12 + a46 + a80,
        a12 + (a46 << 64) - (a80 << 32),
        a12 - (a46 << 32) + (a80 << 64));
    let (a63, a97, a29) = (a63 + a97 + a29,
        a63 + (a97 << 64) - (a29 << 32),
        a63 - (a97 << 32) + (a29 << 64));
    let (a12, a63) = (a12 + a63, a12 - a63);
    let (a46, a97) = (a46 + a97, a46 - a97);
    let (a80, a29) = (a80 + a29, a80 - a29);
    let (a24, a58, a92) = (a24 + a58 + a92,
        a24 + (a58 << 64) - (a92 << 32),
        a24 - (a58 << 32) + (a92 << 64));
    let (a75, a7, a41) = (a75 + a7 + a41,
        a75 + (a7 << 64) - (a41 << 32),
        a75 - (a7 << 32) + (a41 << 64));
    let (a24, a75) = (a24 + a75, a24 - a75);
    let (a58, a7) = (a58 + a7, a58 - a7);
    let (a92, a41) = (a92 + a41, a92 - a41);
    let (a90, a22, a56) = (a90 + a22 + a56,
        a90 + (a22 << 64) - (a56 << 32),
        a90 - (a22 << 32) + (a56 << 64));
    let (a39, a73, a5) = (a39 + a73 + a5,
        a39 + (a73 << 64) - (a5 << 32),
        a39 - (a73 << 32) + (a5 << 64));
    let (a90, a39) = (a90 + a39, a90 - a39);
    let (a22, a73) = (a22 + a73, a22 - a73);
    let (a56, a5) = (a56 + a5, a56 - a5);
    let (a84, a16, a50) = (a84 + a16 + a50,
        a84 + (a16 << 64) - (a50 << 32),
        a84 - (a16 << 32) + (a50 << 64));
    let (a33, a67, a101) = (a33 + a67 + a101,
        a33 + (a67 << 64) - (a101 << 32),
        a33 - (a67 << 32) + (a101 << 64));
    let (a84, a33) = (a84 + a33, a84 - a33);
    let (a16, a67) = (a16 + a67, a16 - a67);
    let (a50, a101) = (a50 + a101, a50 - a101);
    let (a54, a88, a20) = (a54 + a88 + a20,
        a54 + (a88 << 64) - (a20 << 32),
        a54 - (a88 << 32) + (a20 << 64));
    let (a3, a37, a71) = (a3 + a37 + a71,
        a3 + (a37 << 64) - (a71 << 32),
        a3 - (a37 << 32) + (a71 << 64));
    let (a54, a3) = (a54 + a3, a54 - a3);
    let (a88, a37) = (a88 + a37, a88 - a37);
    let (a20, a71) = (a20 + a71, a20 - a71);
    let (a42, a76, a8) = (a42 + a76 + a8,
        a42 + (a76 << 64) - (a8 << 32),
        a42 - (a76 << 32) + (a8 << 64));
    let (a93, a25, a59) = (a93 + a25 + a59,
        a93 + (a25 << 64) - (a59 << 32),
        a93 - (a25 << 32) + (a59 << 64));
    let (a42, a93) = (a42 + a93, a42 - a93);
    let (a76, a25) = (a76 + a25, a76 - a25);
    let (a8, a59) = (a8 + a59, a8 - a59);
    let (a18, a52, a86) = (a18 + a52 + a86,
        a18 + (a52 << 64) - (a86 << 32),
        a18 - (a52 << 32) + (a86 << 64));
    let (a69, a1, a35) = (a69 + a1 + a35,
        a69 + (a1 << 64) - (a35 << 32),
        a69 - (a1 << 32) + (a35 << 64));
    let (a18, a69) = (a18 + a69, a18 - a69);
    let (a52, a1) = (a52 + a1, a52 - a1);
...
mod tests {
    ...
    #[test]
    fn test_small_ntt() {
        for size in [0, 1, 2, 3, 4, 5, 6, 8, 10, 12, 15, 16, 17, 20, 24, 30, 32, 34, 40, 48, 51, 60, 64, 68, 80, 85, 96, 102, 120, 128] {
