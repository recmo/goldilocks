...
fn ntt_10(values: &mut [Field]) {
    ...
    let (a0, a1, a2, a3, a4) = (a0 + a1 + a2 + a3 + a4,
        ...
        a0 + a1 * R53 + a2 * R51 + a3 * R54 + a4 * R52,
        a0 + a1 * R54 + a2 * R53 + a3 * R52 + a4 * R51);
    let (a5, a6, a7, a8, a9) = (a5 + a6 + a7 + a8 + a9,
...
fn ntt_15(values: &mut [Field]) {
    ...
    let (a5, a6, a7, a8, a9) = (a5 + a6 + a7 + a8 + a9,
        ...
        a5 + a6 * R53 + a7 * R51 + a8 * R54 + a9 * R52,
        a5 + a6 * R54 + a7 * R53 + a8 * R52 + a9 * R51);
    let (a10, a11, a12, a13, a14) = (a10 + a11 + a12 + a13 + a14,
...
fn ntt_20(values: &mut [Field]) {
    ...
    let (a5, a6, a7, a8, a9) = (a5 + a6 + a7 + a8 + a9,
        ...
        a5 + a6 * R53 + a7 * R51 + a8 * R54 + a9 * R52,
        a5 + a6 * R54 + a7 * R53 + a8 * R52 + a9 * R51);
    let (a15, a16, a17, a18, a19) = (a15 + a16 + a17 + a18 + a19,
...
fn ntt_30(values: &mut [Field]) {
    ...
    let a28 = values[28];
    let a29 = values[29];
    let (a0, a6, a12, a18, a24) = (a0 + a6 + a12 + a18 + a24,
    ...
    let (a1, a7, a13, a19, a25) = (a1 + a7 + a13 + a19 + a25,
    ...
    let (a2, a8, a14, a20, a26) = (a2 + a8 + a14 + a20 + a26,
    ...
    let (a3, a9, a15, a21, a27) = (a3 + a9 + a15 + a21 + a27,
    ...
    let (a4, a10, a16, a22, a28) = (a4 + a10 + a16 + a22 + a28,
    ...
    let (a5, a11, a17, a23, a29) = (a5 + a11 + a17 + a23 + a29,
...
fn ntt_40(values: &mut [Field]) {
    ...
    let a38 = values[38];
    let a39 = values[39];
    let (a0, a8, a16, a24, a32) = (a0 + a8 + a16 + a24 + a32,
    ...
    let (a1, a9, a17, a25, a33) = (a1 + a9 + a17 + a25 + a33,
    ...
    let (a2, a10, a18, a26, a34) = (a2 + a10 + a18 + a26 + a34,
    ...
    let (a3, a11, a19, a27, a35) = (a3 + a11 + a19 + a27 + a35,
    ...
    let (a4, a12, a20, a28, a36) = (a4 + a12 + a20 + a28 + a36,
    ...
    let (a5, a13, a21, a29, a37) = (a5 + a13 + a21 + a29 + a37,
    ...
    let (a6, a14, a22, a30, a38) = (a6 + a14 + a22 + a30 + a38,
    ...
    let (a7, a15, a23, a31, a39) = (a7 + a15 + a23 + a31 + a39,
...
fn ntt_60(values: &mut [Field]) {
    ...
    let (a30, a31, a32, a33, a34) = (a30 + a31 + a32 + a33 + a34,
    ...
    let (a35, a36, a37, a38, a39) = (a35 + a36 + a37 + a38 + a39,
    ...
    let (a40, a41, a42, a43, a44) = (a40 + a41 + a42 + a43 + a44,
    ...
    let (a45, a46, a47, a48, a49) = (a45 + a46 + a47 + a48 + a49,
    ...
    let (a20, a21, a22, a23, a24) = (a20 + a21 + a22 + a23 + a24,
    ...
    let (a25, a26, a27, a28, a29) = (a25 + a26 + a27 + a28 + a29,
    ...
    let (a50, a51, a52, a53, a54) = (a50 + a51 + a52 + a53 + a54,
    ...
    let (a55, a56, a57, a58, a59) = (a55 + a56 + a57 + a58 + a59,
...
fn ntt_80(values: &mut [Field]) {
    ...
    let (a60, a61, a62, a63, a64) = (a60 + a61 + a62 + a63 + a64,
    ...
    let (a65, a66, a67, a68, a69) = (a65 + a66 + a67 + a68 + a69,
    ...
    let (a70, a71, a72, a73, a74) = (a70 + a71 + a72 + a73 + a74,
    ...
    let (a75, a76, a77, a78, a79) = (a75 + a76 + a77 + a78 + a79,
...
fn ntt_120(values: &mut [Field]) {
    ...
    let (a0, a12, a24, a36, a48) = (a0 + a12 + a24 + a36 + a48,
    ...
    let (a60, a72, a84, a96, a108) = (a60 + a72 + a84 + a96 + a108,
    ...
    let (a1, a13, a25, a37, a49) = (a1 + a13 + a25 + a37 + a49,
    ...
    let (a61, a73, a85, a97, a109) = (a61 + a73 + a85 + a97 + a109,
    ...
    let (a2, a14, a26, a38, a50) = (a2 + a14 + a26 + a38 + a50,
    ...
    let (a62, a74, a86, a98, a110) = (a62 + a74 + a86 + a98 + a110,
    ...
    let (a3, a15, a27, a39, a51) = (a3 + a15 + a27 + a39 + a51,
    ...
    let (a63, a75, a87, a99, a111) = (a63 + a75 + a87 + a99 + a111,
    ...
    let (a4, a16, a28, a40, a52) = (a4 + a16 + a28 + a40 + a52,
    ...
    let (a64, a76, a88, a100, a112) = (a64 + a76 + a88 + a100 + a112,
    ...
    let (a5, a17, a29, a41, a53) = (a5 + a17 + a29 + a41 + a53,
    ...
    let (a65, a77, a89, a101, a113) = (a65 + a77 + a89 + a101 + a113,
    ...
    let (a6, a18, a30, a42, a54) = (a6 + a18 + a30 + a42 + a54,
    ...
    let (a66, a78, a90, a102, a114) = (a66 + a78 + a90 + a102 + a114,
    ...
    let (a7, a19, a31, a43, a55) = (a7 + a19 + a31 + a43 + a55,
    ...
    let (a67, a79, a91, a103, a115) = (a67 + a79 + a91 + a103 + a115,
    ...
    let (a8, a20, a32, a44, a56) = (a8 + a20 + a32 + a44 + a56,
    ...
    let (a68, a80, a92, a104, a116) = (a68 + a80 + a92 + a104 + a116,
    ...
    let (a9, a21, a33, a45, a57) = (a9 + a21 + a33 + a45 + a57,
    ...
    let (a69, a81, a93, a105, a117) = (a69 + a81 + a93 + a105 + a117,
    ...
    let (a10, a22, a34, a46, a58) = (a10 + a22 + a34 + a46 + a58,
    ...
    let (a70, a82, a94, a106, a118) = (a70 + a82 + a94 + a106 + a118,
    ...
    let (a11, a23, a35, a47, a59) = (a11 + a23 + a35 + a47 + a59,
    ...
    let (a71, a83, a95, a107, a119) = (a71 + a83 + a95 + a107 + a119,
...
fn ntt_160(values: &mut [Field]) {
    ...
    let (a0, a16, a32, a48, a64) = (a0 + a16 + a32 + a48 + a64,
    ...
    let (a80, a96, a112, a128, a144) = (a80 + a96 + a112 + a128 + a144,
    ...
    let (a1, a17, a33, a49, a65) = (a1 + a17 + a33 + a49 + a65,
    ...
    let (a81, a97, a113, a129, a145) = (a81 + a97 + a113 + a129 + a145,
    ...
    let (a2, a18, a34, a50, a66) = (a2 + a18 + a34 + a50 + a66,
    ...
    let (a82, a98, a114, a130, a146) = (a82 + a98 + a114 + a130 + a146,
    ...
    let (a3, a19, a35, a51, a67) = (a3 + a19 + a35 + a51 + a67,
    ...
    let (a83, a99, a115, a131, a147) = (a83 + a99 + a115 + a131 + a147,
    ...
    let (a4, a20, a36, a52, a68) = (a4 + a20 + a36 + a52 + a68,
    ...
    let (a84, a100, a116, a132, a148) = (a84 + a100 + a116 + a132 + a148,
    ...
    let (a5, a21, a37, a53, a69) = (a5 + a21 + a37 + a53 + a69,
    ...
    let (a85, a101, a117, a133, a149) = (a85 + a101 + a117 + a133 + a149,
    ...
    let (a6, a22, a38, a54, a70) = (a6 + a22 + a38 + a54 + a70,
    ...
    let (a86, a102, a118, a134, a150) = (a86 + a102 + a118 + a134 + a150,
    ...
    let (a7, a23, a39, a55, a71) = (a7 + a23 + a39 + a55 + a71,
    ...
    let (a87, a103, a119, a135, a151) = (a87 + a103 + a119 + a135 + a151,
    ...
    let (a8, a24, a40, a56, a72) = (a8 + a24 + a40 + a56 + a72,
    ...
    let (a88, a104, a120, a136, a152) = (a88 + a104 + a120 + a136 + a152,
    ...
    let (a9, a25, a41, a57, a73) = (a9 + a25 + a41 + a57 + a73,
    ...
    let (a89, a105, a121, a137, a153) = (a89 + a105 + a121 + a137 + a153,
    ...
    let (a10, a26, a42, a58, a74) = (a10 + a26 + a42 + a58 + a74,
    ...
    let (a90, a106, a122, a138, a154) = (a90 + a106 + a122 + a138 + a154,
    ...
    let (a11, a27, a43, a59, a75) = (a11 + a27 + a43 + a59 + a75,
    ...
    let (a91, a107, a123, a139, a155) = (a91 + a107 + a123 + a139 + a155,
    ...
    let (a12, a28, a44, a60, a76) = (a12 + a28 + a44 + a60 + a76,
    ...
    let (a92, a108, a124, a140, a156) = (a92 + a108 + a124 + a140 + a156,
    ...
    let (a13, a29, a45, a61, a77) = (a13 + a29 + a45 + a61 + a77,
    ...
    let (a93, a109, a125, a141, a157) = (a93 + a109 + a125 + a141 + a157,
    ...
    let (a14, a30, a46, a62, a78) = (a14 + a30 + a46 + a62 + a78,
    ...
    let (a94, a110, a126, a142, a158) = (a94 + a110 + a126 + a142 + a158,
    ...
    let (a15, a31, a47, a63, a79) = (a15 + a31 + a47 + a63 + a79,
    ...
    let (a95, a111, a127, a143, a159) = (a95 + a111 + a127 + a143 + a159,
...
fn ntt_240(values: &mut [Field]) {
    ...
    let (a80, a96, a112, a128, a144) = (a80 + a96 + a112 + a128 + a144,
        ...
        a80 + a96 * R53 + a112 * R51 + a128 * R54 + a144 * R52,
        a80 + a96 * R54 + a112 * R53 + a128 * R52 + a144 * R51);
    let (a160, a176, a192, a208, a224) = (a160 + a176 + a192 + a208 + a224,
    ...
    let (a81, a97, a113, a129, a145) = (a81 + a97 + a113 + a129 + a145,
        ...
        a81 + a97 * R53 + a113 * R51 + a129 * R54 + a145 * R52,
        a81 + a97 * R54 + a113 * R53 + a129 * R52 + a145 * R51);
    let (a161, a177, a193, a209, a225) = (a161 + a177 + a193 + a209 + a225,
    ...
    let (a82, a98, a114, a130, a146) = (a82 + a98 + a114 + a130 + a146,
        ...
        a82 + a98 * R53 + a114 * R51 + a130 * R54 + a146 * R52,
        a82 + a98 * R54 + a114 * R53 + a130 * R52 + a146 * R51);
    let (a162, a178, a194, a210, a226) = (a162 + a178 + a194 + a210 + a226,
    ...
    let (a83, a99, a115, a131, a147) = (a83 + a99 + a115 + a131 + a147,
        ...
        a83 + a99 * R53 + a115 * R51 + a131 * R54 + a147 * R52,
        a83 + a99 * R54 + a115 * R53 + a131 * R52 + a147 * R51);
    let (a163, a179, a195, a211, a227) = (a163 + a179 + a195 + a211 + a227,
    ...
    let (a84, a100, a116, a132, a148) = (a84 + a100 + a116 + a132 + a148,
        ...
        a84 + a100 * R53 + a116 * R51 + a132 * R54 + a148 * R52,
        a84 + a100 * R54 + a116 * R53 + a132 * R52 + a148 * R51);
    let (a164, a180, a196, a212, a228) = (a164 + a180 + a196 + a212 + a228,
    ...
    let (a85, a101, a117, a133, a149) = (a85 + a101 + a117 + a133 + a149,
        ...
        a85 + a101 * R53 + a117 * R51 + a133 * R54 + a149 * R52,
        a85 + a101 * R54 + a117 * R53 + a133 * R52 + a149 * R51);
    let (a165, a181, a197, a213, a229) = (a165 + a181 + a197 + a213 + a229,
    ...
    let (a86, a102, a118, a134, a150) = (a86 + a102 + a118 + a134 + a150,
        ...
        a86 + a102 * R53 + a118 * R51 + a134 * R54 + a150 * R52,
        a86 + a102 * R54 + a118 * R53 + a134 * R52 + a150 * R51);
    let (a166, a182, a198, a214, a230) = (a166 + a182 + a198 + a214 + a230,
    ...
    let (a87, a103, a119, a135, a151) = (a87 + a103 + a119 + a135 + a151,
        ...
        a87 + a103 * R53 + a119 * R51 + a135 * R54 + a151 * R52,
        a87 + a103 * R54 + a119 * R53 + a135 * R52 + a151 * R51);
    let (a167, a183, a199, a215, a231) = (a167 + a183 + a199 + a215 + a231,
    ...
    let (a88, a104, a120, a136, a152) = (a88 + a104 + a120 + a136 + a152,
        ...
        a88 + a104 * R53 + a120 * R51 + a136 * R54 + a152 * R52,
        a88 + a104 * R54 + a120 * R53 + a136 * R52 + a152 * R51);
    let (a168, a184, a200, a216, a232) = (a168 + a184 + a200 + a216 + a232,
    ...
    let (a89, a105, a121, a137, a153) = (a89 + a105 + a121 + a137 + a153,
        ...
        a89 + a105 * R53 + a121 * R51 + a137 * R54 + a153 * R52,
        a89 + a105 * R54 + a121 * R53 + a137 * R52 + a153 * R51);
    let (a169, a185, a201, a217, a233) = (a169 + a185 + a201 + a217 + a233,
    ...
    let (a90, a106, a122, a138, a154) = (a90 + a106 + a122 + a138 + a154,
        ...
        a90 + a106 * R53 + a122 * R51 + a138 * R54 + a154 * R52,
        a90 + a106 * R54 + a122 * R53 + a138 * R52 + a154 * R51);
    let (a170, a186, a202, a218, a234) = (a170 + a186 + a202 + a218 + a234,
    ...
    let (a91, a107, a123, a139, a155) = (a91 + a107 + a123 + a139 + a155,
        ...
        a91 + a107 * R53 + a123 * R51 + a139 * R54 + a155 * R52,
        a91 + a107 * R54 + a123 * R53 + a139 * R52 + a155 * R51);
    let (a171, a187, a203, a219, a235) = (a171 + a187 + a203 + a219 + a235,
    ...
    let (a92, a108, a124, a140, a156) = (a92 + a108 + a124 + a140 + a156,
        ...
        a92 + a108 * R53 + a124 * R51 + a140 * R54 + a156 * R52,
        a92 + a108 * R54 + a124 * R53 + a140 * R52 + a156 * R51);
    let (a172, a188, a204, a220, a236) = (a172 + a188 + a204 + a220 + a236,
    ...
    let (a93, a109, a125, a141, a157) = (a93 + a109 + a125 + a141 + a157,
        ...
        a93 + a109 * R53 + a125 * R51 + a141 * R54 + a157 * R52,
        a93 + a109 * R54 + a125 * R53 + a141 * R52 + a157 * R51);
    let (a173, a189, a205, a221, a237) = (a173 + a189 + a205 + a221 + a237,
    ...
    let (a94, a110, a126, a142, a158) = (a94 + a110 + a126 + a142 + a158,
        ...
        a94 + a110 * R53 + a126 * R51 + a142 * R54 + a158 * R52,
        a94 + a110 * R54 + a126 * R53 + a142 * R52 + a158 * R51);
    let (a174, a190, a206, a222, a238) = (a174 + a190 + a206 + a222 + a238,
    ...
    let (a95, a111, a127, a143, a159) = (a95 + a111 + a127 + a143 + a159,
        ...
        a95 + a111 * R53 + a127 * R51 + a143 * R54 + a159 * R52,
        a95 + a111 * R54 + a127 * R53 + a143 * R52 + a159 * R51);
    let (a175, a191, a207, a223, a239) = (a175 + a191 + a207 + a223 + a239,
